  ...
  return (
    <div className="flex min-h-screen flex-col pb-24 sm:pb-8">
      ...
      <div className="mx-auto flex w-full max-w-3xl items-center justify-between px-4 pt-3 text-xs sm:px-6">
        ...
        <Link href="/kids/exit" className="inline-flex items-center gap-1 rounded-full bg-card/70 px-3 py-1.5 font-medium text-muted-foreground shadow-sm hover:text-foreground">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 pt-4 sm:px-6">{children}</main>
    </div>
  );
}
